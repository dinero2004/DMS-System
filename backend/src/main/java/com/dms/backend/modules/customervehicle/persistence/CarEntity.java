...
public class CarEntity {
    ...
    @Column(name = "type_approval", length = 80) private String typeApproval;
    ...
    public String getTypeApproval() { return typeApproval; }
    public void setTypeApproval(String typeApproval) { this.typeApproval = typeApproval; }
