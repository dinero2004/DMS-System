...
import com.dms.backend.shared.pdf.PdfLanguage;
...
public class FinanceController {
    ...
    @GetMapping("/{id}/pdf") public ResponseEntity<byte[]> pdf(@PathVariable String id, HttpServletRequest request) {
        ...
        byte[] bytes = pdfService.render(inv, client, job, car, items, salesContract, PdfLanguage.resolve(request));
